...
enum {DUMMY, THRESHOLD, CONTRAST, QUANTIZATION, HISTOGRAMSTRETCHING,  HISTOGRAMMATCHING, BLUR, SHARPEN, MEDIAN};
enum {RGB, R, G, B, GRAY};
...
MainWindow::createActions()
{
	...
	m_actionQuantization = new QAction("Qua&ntization", this);
